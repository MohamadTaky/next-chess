...
import LastMoveIndicator from "@/components/shared/board/LastMoveIndicator";
...
export default function Board({ tileClickhandler, flipped = false }: BoardProps) {
  ...
  return (
    <div className="relative m-auto aspect-square w-full max-w-[380px] rounded-sm lg:max-w-[420px]">
      <svg
        className={cn(
          "h-full w-full stroke-black/80 transition duration-500",
